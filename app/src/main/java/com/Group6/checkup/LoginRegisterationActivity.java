                ...
                if (!AccountValidation.isEmpty(etFirstName) && !AccountValidation.isEmpty(etLastName) && !AccountValidation.isEmpty(etLoginID) && !AccountValidation.isEmpty((etPassword)) &&
                    ...
                    if (etLoginID.getText().toString().charAt(0) != 'P') {
                        ...
                        if (patientDao.exists(etLoginID.getText().toString())) {
                            ...
                            if (inserted) {
                                Toast.makeText(LoginRegisterationActivity.this, etLoginID.getText().toString() + " created", Toast.LENGTH_LONG).show();
                                startActivity(new Intent(getBaseContext(), LoginActivity.class));

                                //
                                Intent in = new Intent(LoginRegisterationActivity.this, LoginActivity.class);
                                in.putExtra("loginIDvalue", etLoginID.getText().toString());
                                startActivity(in);
                            } else
                                Toast.makeText(LoginRegisterationActivity.this, "Unable to Create Account", Toast.LENGTH_SHORT).show();
