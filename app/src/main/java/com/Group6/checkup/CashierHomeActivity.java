...
public class CashierHomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView nameTV = findViewById(R.id.text_cashier_name);
        ...
        btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(CashierHomeActivity.this, ViewPendingPaymentsActivity.class));
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_home:
                Intent h = new Intent(CashierHomeActivity.this, CashierHomeActivity.class);
                startActivity(h);
                break;
            case R.id.nav_logout:
                Intent is = new Intent(CashierHomeActivity.this, LoginActivity.class);
                startActivity(is);
                break;
