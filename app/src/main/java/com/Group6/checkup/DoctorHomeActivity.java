...
public class DoctorHomeActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String FullName = doctorFirstName + " " + doctorLastName;
        ...
        buttonViewMessages.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                startActivity(new Intent(DoctorHomeActivity.this, DoctorMessages.class));
            }
        });
        ...
        buttonViewSchedule.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(DoctorHomeActivity.this, DoctorAppointmentScheduleActivity.class));
            }
        });
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        switch (id) {
            ...
            case R.id.nav_home:
                Intent h = new Intent(DoctorHomeActivity.this, DoctorHomeActivity.class);
                startActivity(h);
                break;
            case R.id.nav_logout:
                Intent s = new Intent(DoctorHomeActivity.this, LoginActivity.class);
                startActivity(s);
                break;
